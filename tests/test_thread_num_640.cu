...
namespace Gbuilder {
namespace Gpu {
TEST(TestSearch, DISABLED_SizeTest) {
  SPDLOG_INFO(
      "the size is {}",
...
// TEST(TestSearch, DISABLED_TestSelectTopPSimple) {
...
//   test<Km, Kp, Kd, uint32_t, float, 0XFFFFFFFF><<<1, 32>>>(d_list, d_list +
//   Km); cpu_ref<Km, Kp, Kd, uint32_t, float,
//   0XFFFFFFFF>(check_host_list.data(),
//                                                    check_host_list.data() +
//                                                    Km);
...
// TEST(TestSearch, DISABLED_Gpulink_process_v0_block_1024) {
//   constexpr uint32_t dim = 200;
...
// TEST(TestSearch, DISABLED_Gpulink_process_v0_block_512) {
//   constexpr uint32_t dim = 200;
//   constexpr uint32_t degree = 16;
//   constexpr uint32_t base_num = 10 * 1000 * 1000;
//   constexpr uint32_t query_num = 10 * 1000 * 1000;
...
TEST(TestSearch, Gpulink_process_v0_block_640) {
  constexpr uint32_t dim = 512;
  constexpr uint32_t degree = 16;
  constexpr uint32_t base_num = 1 * 1000 * 1000;
  constexpr uint32_t query_num = 1 * 1000 * 1000;
  constexpr uint32_t grid_size = 144;
  constexpr uint32_t block_size = 640;
  constexpr uint32_t Km = 32;
  constexpr uint32_t Kp = 2;
  constexpr uint32_t Kd = 16;
  constexpr uint32_t topk = Km + Kp * Kd;
...
// TEST(TestSearch, DISABLED_Gpulink_process_v0_store_base_data_block_1024) {
//   cudaDeviceSynchronize();
...
//                                   dim, degree, shared_memory_size, Km, Kp,
//                                   Kd, topk, 0XFFFFFFFF, hashtable_size,
...
// TEST(TestSearch, DISABLED_Gpulink_process_v0_store_base_data_block_512) {
//   cudaDeviceSynchronize();
...
// TEST(TestSearch, DISABLED_Gpulink_process_v0_store_base_data_block_768) {
//   cudaDeviceSynchronize();
...
// TEST(TestSearch, DISABLED_Gpulink_process_v0_xxx_768) {
//   cudaDeviceSynchronize();
...
//   SPDLOG_INFO("begin gpu searching");
//   link_process_v0_xxx<grid_size, block_size, base_num, query_num, dim,
//   degree,
//                       shared_memory_size, Km, Kp, Kd, topk, 0XFFFFFFFF,
//                       hashtable_size, reset_iter, uint32_t, float>
...
// TEST(TestSearch, DISABLED_Gpulink_process_v1) {
//   cudaDeviceSynchronize();
//   constexpr uint32_t dim = 200;
//   constexpr uint32_t degree = 16;
//   constexpr uint32_t base_num = 10 * 1000 * 1000;
...
//   SPDLOG_INFO("begin gpu searching");
//   link_process_v1<grid_size, block_size, base_num, query_num, dim, degree,
//                   shared_memory_size, Km, Kp, Kd, topk, 0XFFFFFFFF,
//                   hashtable_size, reset_iter, uint32_t, float>
//       <<<grid_size, block_size, shared_memory_size>>>(d_base_data,
//       d_hashtables,
...
//   dump_vec2_file(check_res,
//                  "/home/shiwen/project/GGidxbuild/data/gpu_search_res_v1.ibin");
...
// TEST(TestSearch, DISABLED_Gpulink_process_v2) {
//   cudaDeviceSynchronize();
//   constexpr uint32_t dim = 200;
//   constexpr uint32_t degree = 16;
//   constexpr uint32_t base_num = 10 * 1000 * 1000;
...
//   SPDLOG_INFO("begin gpu searching");
//   link_process_v2<grid_size, block_size, base_num, query_num, dim, degree,
//                   shared_memory_size, Km, Kp, Kd, topk, 0XFFFFFFFF,
//                   hashtable_size, reset_iter, uint32_t, float>
//       <<<grid_size, block_size, shared_memory_size>>>(d_base_data,
//       d_hashtables,
...
//   dump_vec2_file(check_res,
//                  "/home/shiwen/project/GGidxbuild/data/gpu_search_res_v2.ibin");
...
// TEST(TestSearch, DISABLED_Gpulink_process_v3) {
//   cudaDeviceSynchronize();
//   constexpr uint32_t dim = 200;
//   constexpr uint32_t degree = 16;
//   constexpr uint32_t base_num = 10 * 1000 * 1000;
...
//   SPDLOG_INFO("begin gpu searching");
//   link_process_v3<grid_size, block_size, base_num, query_num, dim, degree,
//                   shared_memory_size, Km, Kp, Kd, topk, 0XFFFFFFFF,
//                   hashtable_size, reset_iter, uint32_t, float>
//       <<<grid_size, block_size, shared_memory_size>>>(d_base_data,
//       d_hashtables,
...
//   dump_vec2_file(check_res,
//                  "/home/shiwen/project/GGidxbuild/data/gpu_search_res_v3.ibin");
